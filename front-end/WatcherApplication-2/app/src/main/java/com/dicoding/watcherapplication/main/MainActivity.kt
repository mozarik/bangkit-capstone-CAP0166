            ...
            call.enqueue(object : Callback<ResponseBody>{
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    ...
                    try {
                        ...
                        val dataImg = jsonObjectData.getString("img_url")
                        val dataId = jsonObjectData.getString("id")
                        println("code 202: response status: " + status)
                        println("code 203: response data: " + data)
                        println("code 204: response data id: " + dataId)
                        println("code 205: response data img_url: " + dataImg)
                    } catch (e: Exception){
                        e.printStackTrace()
                    }
